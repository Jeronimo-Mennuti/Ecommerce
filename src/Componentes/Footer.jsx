...
import { ChakraProvider, Box, Flex, Image, Text, CSSReset, Icon } from '@chakra-ui/react';
    ...
    return (
        <ChakraProvider>
            ...
            <Flex
                ...
                position="relative"
            >
                <Box mb={{ base: 10, md: 0 }} display={{ base: 'none', md: 'block' }}>
                ...
                {/* Columna con iconos de correo electrónico, ubicación y teléfono */}
                ...
                <Box
                    ...
                    _hover={{
                        color: 'pink.200',
                        transform: 'scale(1.2)',  // Cambia el tamaño al 120% en hover
                    }}
